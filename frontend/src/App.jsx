...
import { CreateTask, GetAllTasks, DeleteTask, ToggleTask,UpdateTask } from "../wailsjs/go/handler/TaskHandler.js";
            ...
            <ul className="task-list">
                {filteredTasks.map((t) => (
                    <li key={t.id} className={t.done ? "done" : ""}>
                        ...
                        <button className="edit-btn" onClick={() => confirmEdit(t)}>✏️</button>
